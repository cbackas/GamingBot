...
public class ConfigManager {
    ...
    static {
        ...
        defaultConfig.put("date", "gamenight date/time");
        defaultConfig.put("mnID", "gamenight announce messageID");
    ...
    public ConfigManager(GamingBot bot) {
        this.bot = bot;
        initConfig();
    }
    ...
    private void initConfig() {
        try {
            configFile = new File(Util.botPath, "gamingconfig.json");
