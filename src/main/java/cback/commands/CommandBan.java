                    ...
                    if (reason != null) {
                        ...
                        if (user.getID().equals(mod.getID())) {
                            ...
                            try {
                                ...
                                Util.sendMessage(message.getChannel(), user.getDisplayName(guild) + " has been banned. Check " + guild.getChannelByID(GamingBot.LOG_CHANNEL_ID).mention() + " for more info.");
                            } catch (Exception e) {
                                e.printStackTrace();
